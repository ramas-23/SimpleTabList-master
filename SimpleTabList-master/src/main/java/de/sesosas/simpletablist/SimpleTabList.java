...
public final class SimpleTabList extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        // Start updating all players asynchronously every second
        updateAllPlayersAsync();
    ...
    private void setupDefaultConfig() {
        String[] headerString = new String[]{"This is a header and animation {animation:0}!", "You: %player_name%!"};
        String[] footerString = new String[] {"This is a footer!", "This is footer line 2!"};
    ...
    // Método helper para actualizar todos los jugadores cada segundo
    private void updateAllPlayersAsync() {
        Bukkit.getScheduler().runTaskTimer(this, NamesClass::updateAllPlayers, 20L, 20L);
    }
}
